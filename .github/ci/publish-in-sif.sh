...
# (project=scitex-datetime, owner=ywatanabe1989, repo=scitex-datetime,
...
TMPDIR="/tmp/publish-scitex_datetime-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-datetime dist/* uploaded to PyPI via manual OIDC trusted publishing"
